...
const AttributeCombatPage = () => {
  return (
    <PageContentMenuSheet>
      <Column gap ="22px" width="997px" height="1519.5px">
        <Row gap ="22px" width="997px" height="1063.51px">
          <Attributes/>
          <Column gap ="7px" width="821px" height="1058px">
            <Row gap ="22px" width="818px" height="192px" >
              <Life/>
              <Defense/>
            </Row>
            ...
            <Row gap ="11px" width="811px" height="859px">
              ...
              <Column gap ="22px" width="260px" height="838px">
                <ResistanceTest/>
                <Skills/>
              </Column>
